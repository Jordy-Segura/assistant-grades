...
import { COMPONENT_WEIGHTS, COMPONENT_COLORS, COMPONENT_LABELS, COMPONENTS, COORDINADOR, ROLE_LABEL } from "./runtime/constants.js";
...
export function initLegacyRuntime() {
  ...
  function onCarreraChange() {
    ...
    var carreraData = getCatalogCareer(carreraValue);
  ...
  function onPaoChange() {
    ...
    if (STATE.currentUser) {
      ...
      var carreraDataForPao = getCatalogCareer(carreraValue);
  ...
  function onAsignaturaChange() {
    ...
    var carreraDataForSubject = getCatalogCareer(carrera);
  ...
  function collectMappedRAAUs() {
    ...
    var carreraDataForRaau = getCatalogCareer(carrera);
