...
export function initLegacyRuntime() {
  ...
  function renderConsultaEstudiante() {
    ...
    target.innerHTML =
      ...
      '<div class="form-group"><label class="form-label">Cédula</label><input class="form-input" id="cest-cedula" placeholder="Ej: 220023003-1" maxlength="12" oninput="cestValidateCedula()"></div>' +
  ...
  function renderConsultaHistorial() {
    ...
    target.innerHTML =
      ...
      '<div class="form-group"><label class="form-label">Cédula</label><input class="form-input" id="chist-cedula" placeholder="Ej: 220023003-1" maxlength="12" oninput="chistValidate()"></div>' +
  ...
  function renderConsultaCedula() {
    ...
    target.innerHTML =
      ...
      '<div class="form-group"><label class="form-label">Número de Cédula</label><input class="form-input" id="cced-cedula" placeholder="Ej: 220023003-1" maxlength="12" oninput="ccedValidate()"></div>' +
