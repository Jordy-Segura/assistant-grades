...
export default function Sidebar({ onToggle, sidebarOpen, onNavClick }) {
  const handleNavClick = (e, page) => {
    e.preventDefault();
    if (onNavClick) onNavClick();
    callGlobal("navigate", page);
  };

  return (
    <aside id="sidebar" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="sidebar-pao-section" id="sidebar-pao-section">
        <div className="sidebar-pao-header">
          ...
          <button className="btn btn-ghost btn-sm" onClick={() => {
            if (onNavClick) onNavClick();
            callGlobal("cfgStartNew");
          }} title="Nuevo PAO" style={{padding:"1px 6px",fontSize:"1.1rem",lineHeight:1}}>+</button>
        </div>
        <div id="sidebar-pao-list"></div>
      </div>

      <nav className="sidebar-nav">
        <a className="nav-item active" data-page="dashboard" href="#dashboard" onClick={(e) => handleNavClick(e, "dashboard")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
          Dashboard
        </a>
        <a className="nav-item" data-page="configuracion" href="#configuracion" onClick={(e) => handleNavClick(e, "configuracion")}>
        ...
        <a className="nav-item" data-page="estudiantes" href="#estudiantes" onClick={(e) => handleNavClick(e, "estudiantes")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          Estudiantes
        </a>
        <a className="nav-item" data-page="calificaciones" href="#calificaciones" onClick={(e) => handleNavClick(e, "calificaciones")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
          Calificaciones
        </a>
        <a className="nav-item" data-page="reporte" href="#reporte" onClick={(e) => handleNavClick(e, "reporte")}>
        ...
        <a className="nav-item" data-page="coordinacion" id="nav-coordinacion" href="#coordinacion" onClick={(e) => handleNavClick(e, "coordinacion")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 3h18v18H3z"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
          Coordinación
        </a>
        <a className="nav-item" data-page="coord-asignaturas" id="nav-coord-asig" href="#coord-asignaturas" onClick={(e) => handleNavClick(e, "coord-asignaturas")}>
        ...
        <a className="nav-item" data-page="coord-rac" id="nav-coord-rac" href="#coord-rac" onClick={(e) => handleNavClick(e, "coord-rac")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>
          RAC
        </a>
        <a className="nav-item" data-page="coord-raau" id="nav-coord-raau" href="#coord-raau" onClick={(e) => handleNavClick(e, "coord-raau")}>
        ...
        <a className="nav-item" data-page="coord-docentes" id="nav-coord-docentes" href="#coord-docentes" onClick={(e) => handleNavClick(e, "coord-docentes")}>
        ...
        <a className="nav-item" data-page="consulta-sede" id="nav-consulta-sede" href="#consulta-sede" onClick={(e) => handleNavClick(e, "consulta-sede")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
          Sede Orellana
        </a>
        <a className="nav-item" data-page="consulta-informacion" id="nav-consulta-info" href="#consulta-informacion" onClick={(e) => handleNavClick(e, "consulta-informacion")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
          Información General
        </a>
        <a className="nav-item" data-page="consulta-estudiante" id="nav-consulta-est" href="#consulta-estudiante" onClick={(e) => handleNavClick(e, "consulta-estudiante")}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          Datos de Estudiante
        </a>
      </nav>
